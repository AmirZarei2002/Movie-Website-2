const Footer = () => {
    return (
        <div>
            <footer className="text-center text-white bg-gray-300 mt-10">
                <div className="pt-5">
                ...
                <div className="text-center text-gray-700 p-4 bg-gray-200">
                    © 2021 Copyright:
                    <a className="text-gray-800" href="https://tailwind-elements.com/">Movie Website</a>
                </div>
            </footer>
        </div>
    )
